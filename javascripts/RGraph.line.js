    ...
    */
    RGraph.Line.prototype.DrawLine = function (lineData, color, fill, linewidth, tickmarks, index)
    {
        ...
        var xInterval = (RGraph.GetWidth(this) - (2 * this.Get('chart.hmargin')) - this.gutterLeft - this.gutterRight) / (lineData.length - 1);
            ...
            */
            ...
            if (i == 0 || penUp || !yPos || !prevY || prevY < this.gutterTop) {
                ...
                if (this.Get('chart.filled') && !this.Get('chart.filled.range')) {
                    this.context.moveTo(xPos + 1, RGraph.GetHeight(this) - this.gutterBottom - (this.Get('chart.xaxispos') == 'center' ? (RGraph.GetHeight(this) - this.gutterTop - this.gutterBottom) / 2 : 0) -1);
    ...
    */
    RGraph.Line.prototype.DrawTick = function (lineData, xPos, yPos, color, isShadow, prevX, prevY, tickmarks, index)
    {
        ...
        if ((yPos == null || yPos > (RGraph.GetHeight(this) - this.gutterBottom) || yPos < this.gutterTop) && !this.Get('chart.outofbounds')) {
            return;
        }
